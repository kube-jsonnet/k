      ...
      podSecurityPolicy:: {
        ...
        mixin:: {
          ...
          spec:: {
            ...
            runtimeClass:: {
              local __runtimeClassMixin(runtimeClass) = __specMixin({ runtimeClass+: runtimeClass }),
              mixinInstance(runtimeClass):: __runtimeClassMixin(runtimeClass),
              // allowedRuntimeClassNames is a whitelist of RuntimeClass names that may be specified on a pod. A value of "*" means that any RuntimeClass name is allowed, and must be the only item in the list. An empty list requires the RuntimeClassName field to be unset.
              withAllowedRuntimeClassNames(allowedRuntimeClassNames):: self + if std.type(allowedRuntimeClassNames) == 'array' then __runtimeClassMixin({ allowedRuntimeClassNames: allowedRuntimeClassNames }) else __runtimeClassMixin({ allowedRuntimeClassNames: [allowedRuntimeClassNames] }),
              // allowedRuntimeClassNames is a whitelist of RuntimeClass names that may be specified on a pod. A value of "*" means that any RuntimeClass name is allowed, and must be the only item in the list. An empty list requires the RuntimeClassName field to be unset.
              withAllowedRuntimeClassNamesMixin(allowedRuntimeClassNames):: self + if std.type(allowedRuntimeClassNames) == 'array' then __runtimeClassMixin({ allowedRuntimeClassNames+: allowedRuntimeClassNames }) else __runtimeClassMixin({ allowedRuntimeClassNames+: [allowedRuntimeClassNames] }),
              // defaultRuntimeClassName is the default RuntimeClassName to set on the pod. The default MUST be allowed by the allowedRuntimeClassNames list. A value of nil does not mutate the Pod.
              withDefaultRuntimeClassName(defaultRuntimeClassName):: self + __runtimeClassMixin({ defaultRuntimeClassName: defaultRuntimeClassName }),
            },
            runtimeClassType:: hidden.extensions.v1beta1.runtimeClassStrategyOptions,
